...
```
4. 接下来写方块的功能 TFC食物数据 ```/kubejs/data/kubejs/tfc/food/example_decaying_block.json```
``` Json
{
    "ingredient": {
...
```
4. TFC data food item. ```/kubejs/data/kubejs/tfc/food/example_decaying_block.json```
``` Json
{
    "ingredient": {
        "item": "kubejs:example_decaying_block"
